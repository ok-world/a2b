...
-- Usage:
-- mysql -u root -p"root password" < 6hM4onQSdVaT-schema-mysql-v1.4.0.sql
...
CREATE TABLE IF NOT EXISTS `cc_alarm` (
  ...
  `datelastrun` timestamp NOT NULL default '1971-01-01 00:00:01',
...
CREATE TABLE IF NOT EXISTS `cc_call` (
  ...
  `stoptime` timestamp NOT NULL default '1971-01-01 00:00:01',
...
CREATE TABLE IF NOT EXISTS `cc_callback_spool` (
  ...
  `last_attempt_time` timestamp NOT NULL default '1971-01-01 00:00:01',
  `manager_result` varchar(60) collate utf8_bin default NULL,
  `agi_result` varchar(60) collate utf8_bin default NULL,
  `callback_time` timestamp NOT NULL default '1971-01-01 00:00:01',
...
CREATE TABLE IF NOT EXISTS `cc_campaign` (
  ...
  `creationdate` timestamp NOT NULL default CURRENT_TIMESTAMP,
  `startingdate` timestamp NOT NULL default '1971-01-01 00:00:01',
  `expirationdate` timestamp NOT NULL default '1971-01-01 00:00:01',
  `description` mediumtext collate utf8_bin,
...
CREATE TABLE IF NOT EXISTS `cc_card` (
  `id` bigint(20) NOT NULL auto_increment,
  `creationdate` timestamp NOT NULL default CURRENT_TIMESTAMP,
  `firstusedate` timestamp NOT NULL default '1971-01-01 00:00:01',
  `expirationdate` timestamp NOT NULL default '1971-01-01 00:00:01',
  ...
  `currency` char(3) collate utf8_bin default 'USD',
  `lastuse` timestamp NOT NULL default '1971-01-01 00:00:01',
  ...
  `servicelastrun` timestamp NOT NULL default '1971-01-01 00:00:01',
...
CREATE TABLE IF NOT EXISTS `cc_card_subscription` (
  ...
  `stopdate` timestamp NOT NULL default '1971-01-01 00:00:01',
...
CREATE TABLE IF NOT EXISTS `cc_config` (
  ...
  `config_value` varchar(100) collate utf8_bin default NULL,
...
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(17, 'Context Callback', 'context_callback', '6hM4onQSdVaT-callback', 'Contaxt to use in Callback', 0, NULL, 'callback');
...
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(25, 'PD Contect', 'context_preditctivedialer', '6hM4onQSdVaT-predictivedialer', 'The context to redirect the call for the predictive dialer.', 0, NULL, 'callback');
...
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(101, 'SIP File Path', 'buddy_sip_file', '/etc/asterisk/additional_6hM4onQSdVaT_sip.conf', 'Path to store the asterisk configuration files SIP.', 0, NULL, 'webui');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(102, 'IAX File Path', 'buddy_iax_file', '/etc/asterisk/additional_6hM4onQSdVaT_iax.conf', 'Path to store the asterisk configuration files IAX.', 0, NULL, 'webui');
...
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(110, 'Audio Directory Path', 'dir_store_audio', '/var/lib/asterisk/sounds/6hM4onQSdVaT', 'Not used yet, The goal is to upload files and use them in the IVR.', 0, NULL, 'webui');
...
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(126, 'Context', 'context', '6hM4onQSdVaT', 'Refer to sip.conf & iax.conf documentation for the meaning of those parameters.', 0, NULL, 'peer_friend');
...
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(132, 'Alarm Log File', 'cront_alarm', '/var/log/6hM4onQSdVaT/cront_a2b_alarm.log', 'To disable application logging, remove/comment the log file name aside service.', 0, NULL, 'log-files');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(133, 'Auto refill Log File', 'cront_autorefill', '/var/log/6hM4onQSdVaT/cront_a2b_autorefill.log', 'To disable application logging, remove/comment the log file name aside service.', 0, NULL, 'log-files');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(134, 'Bactch Process Log File', 'cront_batch_process', '/var/log/6hM4onQSdVaT/cront_a2b_batch_process.log', 'To disable application logging, remove/comment the log file name aside service .', 0, NULL, 'log-files');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(135, 'Archive Log File', 'cront_archive_data', '/var/log/6hM4onQSdVaT/cront_a2b_archive_data.log', 'To disable application logging, remove/comment the log file name aside service .', 0, NULL, 'log-files');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(136, 'DID Billing Log File', 'cront_bill_diduse', '/var/log/6hM4onQSdVaT/cront_a2b_bill_diduse.log', 'To disable application logging, remove/comment the log file name aside service .', 0, NULL, 'log-files');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(137, 'Subscription Fee Log File', 'cront_subscriptionfee', '/var/log/6hM4onQSdVaT/cront_a2b_subscription_fee.log', 'To disable application logging, remove/comment the log file name aside service.', 0, NULL, 'log-files');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(138, 'Currency Cront Log File', 'cront_currency_update', '/var/log/6hM4onQSdVaT/cront_a2b_currency_update.log', 'To disable application logging, remove/comment the log file name aside service.', 0, NULL, 'log-files');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(139, 'Invoice Cront Log File', 'cront_invoice', '/var/log/6hM4onQSdVaT/cront_a2b_invoice.log', 'To disable application logging, remove/comment the log file name aside service.', 0, NULL, 'log-files');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(140, 'Cornt Log File', 'cront_check_account', '/var/log/6hM4onQSdVaT/cront_a2b_check_account.log', 'To disable application logging, remove/comment the log file name aside service .', 0, NULL, 'log-files');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(141, 'Paypal Log File', 'paypal', '/var/log/6hM4onQSdVaT/6hM4onQSdVaT_paypal.log', 'paypal log file, to log all the transaction & error.', 0, NULL, 'log-files');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(142, 'EPayment Log File', 'epayment', '/var/log/6hM4onQSdVaT/6hM4onQSdVaT_epayment.log', 'epayment log file, to log all the transaction & error .', 0, NULL, 'log-files');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(143, 'ECommerce Log File', 'api_ecommerce', '/var/log/6hM4onQSdVaT/6hM4onQSdVaT_api_ecommerce_request.log', 'Log file to store the ecommerce API requests .', 0, NULL, 'log-files');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(144, 'Callback Log File', 'api_callback', '/var/log/6hM4onQSdVaT/6hM4onQSdVaT_api_callback_request.log', 'Log file to store the CallBack API requests.', 0, NULL, 'log-files');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(145, 'Webservice Card Log File', 'api_card', '/var/log/6hM4onQSdVaT/6hM4onQSdVaT_api_card.log', 'Log file to store the Card Webservice Logs', 0, NULL, 'log-files');
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(146, 'AGI Log File', 'agi', '/var/log/6hM4onQSdVaT/6hM4onQSdVaT_agi.log', 'File to log.', 0, NULL, 'log-files');
...
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(174, 'Auto Create Card', 'cid_auto_create_card', '0', 'if the callerID is captured on 6hM4onQSdVaT, this option will create automatically a new card and add the callerID to it.', 1, 'yes,no', 'agi-conf1');
...
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(223, 'Context Campaign''s Callback', 'context_campaign_callback', '6hM4onQSdVaT-campaign-callback', 'Context to use in Campaign of Callback', 0, NULL, 'callback');
...
INSERT INTO `cc_config` (`id`, `config_title`, `config_key`, `config_value`, `config_description`, `config_valuetype`, `config_listvalues`, `config_group_title`) VALUES(227, 'Path for the CDR cache file', 'cache_path', '/etc/asterisk/cache_6hM4onQSdVaT', 'Defined the file that you want use for the CDR cache to save the CDR in a local SQLite database.', 0, NULL, 'global');
...
CREATE TABLE IF NOT EXISTS `cc_did_use` (
  ...
  `releasedate` timestamp NOT NULL default '1971-01-01 00:00:01',
...
CREATE TABLE IF NOT EXISTS `cc_voucher` (
  `id` bigint(20) NOT NULL auto_increment,
  `creationdate` timestamp NOT NULL default CURRENT_TIMESTAMP,
  `usedate` timestamp NOT NULL default '1971-01-01 00:00:01',
  `expirationdate` timestamp NOT NULL default '1971-01-01 00:00:01',
